...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        ...
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{asset('assets/illustration logo.jpg')}}" class="h-8" alt="Logo de clinik" />
        ...
        <div class="hidden w-full md:block md:w-auto m-0" id="navbar-default">
            ...
            <x-navbar-link href="/" :active="request()->is('/')">Accueil</x-navbar-link>
            <x-navbar-link href="/" >A propos</x-navbar-link>
            <x-navbar-link href="/" >Nos Offres</x-navbar-link>
            <x-navbar-link href="/" >Contactez Nous</x-navbar-link>
            ...
            {{-- Button --}}
            @guest
            <x-button-default href='login' active="bg-blue-600 text-white hover:bg-blue-700">Inscription</x-button-default>
            <x-button-default href='register' active="bg-red-600 text-white hover:bg-red-700" >Connexion</x-button-default>
            @else
            <x-navbar-link class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Profile</x-navbar-link> 
            <x-navbar-link class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">Deconnexion</x-navbar-link>    
            @endguest
            </ul>
        </div>
        </div>
    ...
    {{-- Hero Section --}}
    <section class="bg-center bg-no-repeat h-full w-full bg-backgroundImg bg-gray-400 bg-blend-multiply" style="background-image: url('/assets/header-doctor-femme.jpg');">
    ...
    <section class=" mx-4 my-8 bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pourquoi Soft Care ?</h2>
            {{-- <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explorez toute la collection de composants et d'éléments Web open source construits avec les classes utilitaires de Tailwind</p> --}}
        </div> 
            <x-grid-tree-reponsive >
                <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                    Efficacité Améliorée Réduisez les tâches administratives répétitives et concentrez-vous sur ce qui compte vraiment : les soins aux patients. Soft Care automatise les processus clés pour vous faire gagner du temps.
                </div>
                <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                    Qualité des Soins Accédez rapidement et facilement aux dossiers médicaux électroniques, assurez une coordination optimale entre les équipes médicales et améliorez l'expérience des patients
                </div>
                <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                    Accessibilité et Flexibilité Gérez votre établissement de santé à tout moment et de n'importe où grâce à notre plateforme 100% web. Compatible avec tous les appareils, Soft Care vous offre une flexibilité totale
                </div>
            </x-grid-tree-reponsive>
    </section>
    ...
    <section class=" mx-4 my-8 bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Amélioration de la Vie des Patients</h2>
            <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Avec Soft Care, facilitez la vie de vos patients en leur offrant un accès rapide et efficace à des soins de qualité :</p>
        </div> 
        <x-grid-tree-reponsive >
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                Accès Rapide aux Soins Les patients peuvent prendre rendez-vous en ligne en quelques clics, réduisant ainsi les temps d'attente.
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                Télémédecine Permettez à vos patients de consulter leurs médecins depuis le confort de leur domicile grâce aux consultations vidéo sécurisées
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                Dossiers Médicaux Électroniques (DME) Centralisez toutes les informations médicales de vos patients, assurant un suivi précis et une continuité des soins sans faille.
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                Ordonnances Électroniques Fournissez des prescriptions électroniques lisibles et sûres, évitant les erreurs de médication et améliorant la rapidité des soins.
            </div>
        </x-grid-tree-reponsive>
    </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white capitalize">Les fonctionnalités clés</h2>
        </div> 
        <x-grid-tree-reponsive active>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h4>Gestion des patients:</h4>
                <ul>
                    <li>Enregistrement et suivi des patients</li>
                    <li>Accès aux antécédents médicaux</li>
                    <li>Gestion des admissions et des sorties</li>
                </ul>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Planification des Rendez-vous</h2>
                <p>Optimisez la gestion des consultations avec un calendrier intégré et des notifications automatiques. Facilitez la prise de rendez-vous pour vos patients en ligne.</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Facturation et Comptabilité</h2>
                <p>Simplifiez la facturation avec des outils de gestion financière robustes. Suivi des paiements, des remboursements et génération de rapports financiers détaillés.</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Gestion des Ressources</h2>
                <p>Suivez et gérez les stocks de médicaments, les équipements médicaux et le personnel avec une efficacité accrue.</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Consultation Vidéo</h2>
                <p>Le module de télémédecine simple, facile et rapide vous permet de discuter avec le patient par appel vidéo</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Prise de Rendez-vous en Ligne</h2>
                <p>La prise de rendez-vous en ligne permet aux patients d'obtenir rapidement et facilement un rendez-vous en un seul clic.</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Portail du Médecin</h2>
                <p>Gérez le traitement des patients, les ordonnances, la planification des rendez-vous, les tâches et bien plus encore</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Portail des Patients</h2>
                <p>Permettez aux patients de prendre rendez-vous, effectuer des paiements, consulter des informations cliniques et bien plus encore</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100">
                <h2>Portail du Personnel</h2>
                <p>Accès dédié pour les réceptionnistes, pharmaciens, pathologistes, radiologues et comptables, chacun avec des outils adaptés à leurs besoins spécifiques.</p>
            </div>
        </x-grid-tree-reponsive>
    </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Les Cliniques</h2>
                <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explorez toute la collection de composants et d'éléments Web open source construits avec les classes utilitaires de Tailwind</p>
            </div> 
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/background.jpg')}}" alt="Bonnie Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Clinique 1</a>
                        </h3>
                        <span class="text-gray-500 dark:text-gray-400">Par le Docteur </span>
                        <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Un tres bon clinique qui se plait bien surtout quand les patients en parle.</p>
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/background.jpg')}}" alt="Jese Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Clinique 2 </a>
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/background.jpg')}}" alt="Michael Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Clinique 3</a>
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="h-80 rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/background.jpg')}}" alt="Sofia Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Clinique 4</a>
    ...
    <div class="my-10 mx-20">
        <h4 class="text-bold uppercase text-center font-bold text-xl">Parcourez notre plateforme pour trouver le medecin qu'il vous faut</h4>
        <div class="lg:grid lg:grid-cols-3 lg:gap-8  my-2">
            <div class="max-w-sm bg-white  hover:shadow-gray-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg " src="{{asset('assets/medical-question.png')}}" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Questionnaire Médical</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Après avoir précisé la nature de vos symptômes lors d’un questionnaire précédant le diagnostic, Feeli vous oriente immédiatement vers un spécialiste de santé. Sans RDV et en quelques minutes, la téléconsultation débute via une messagerie instantanée, le tout offrant une expérience entièrement digitalisée.</p>
            ...
            <div class="max-w-sm bg-white hover:shadow-gray-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg" src="{{asset('assets/consultation-diagnostic.png')}}" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Consultation et diagnostic</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">À l’aide des réponses au questionnaire, le médecin peut débuter la téléconsultation par messagerie instantanée. Si nécessaire un traitement pourra vous être proposé. Le montant de la téléconsultation est supporté entièrement par le patient.</p>
                    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
                        <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
            ...
            <div class="max-w-sm bg-white hover:shadow-gray-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg" src="{{asset('assets/delivrance-medical.png')}}" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Délivrance de votre remède</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">En fonction du diagnostic et si un remède est nécessaire, le médecin pourra établir un document médical valable en pharmacie, directement accessible depuis votre espace personnel. Si besoin, le médecin pourra compléter votre document médical par des examens complémentaires.</p>
                    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
                        <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
    ...
    <div class="my-10 py-10 mx-full w-full h-auto bg-red-400 text-center">
                <span class="block">Qui va répondre à ma demande ?</span>
        Après avoir répondu au questionnaire, un médecin généraliste démarre la téléconsultation après avoir pris connaissance du dossier de son patient. En cas de besoin, le médecin pourra vous proposer un document médical acceptée en pharmacie contenant votre remède personnalisé ou des examens cliniques supplémentaires.
            <span class="block">Combien de temps l’échange va durer ?</span>
        Le questionnaire de pré diagnostic permet au médecin qui traite votre demande d'obtenir des informations sur votre état de santé. Une fois vos informations consultées par le médecin engagera un échange par messagerie instantanée sans limite de temps.
    </div>


    
    <div class="my-10 mx-20 lg:grid lg:grid-cols-2 lg:gap-8">
        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-lg hover:bg-gray-50 sm:p-8 dark:bg-gray-800 dark:border-gray-700 ">
            <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Offre Standard</h5>
            <div class="flex items-baseline text-gray-900 dark:text-white">
            <span class="text-xl font-semibold">XOF</span>
            <span class="text-2xl font-extrabold tracking-tight"> 10K</span>
            ...
            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">1 Clinique</span>
            </li>
            <li class="flex">
            <svg class="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
            </svg>
            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">100 Gb de storage</span>
            </li>
            <li class="flex">
            <svg class="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
            </svg>
            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">100 Mail /mois</span>
            </li>
            ...
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choisissez votre Offre</button>
        </div>
    </div>

    <div class="mx-20">
        <div id="indicators-carousel" class="relative w-full" data-carousel="static" style="background-image: url(https://tecdn.b-cdn.net/img/Photos/Others/background2.jpg)">
            <!-- Carousel wrapper -->
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96 p-6 text-center shadow-lg md:p-12 md:text-left">
                <!-- Item 1 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                    <div class="md:flex md:flex-row m-4 p-6 absolute block bg-white rounded-md -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 ">
                        <div class="mx-auto mb-6 flex w-36 items-center justify-center md:mx-0 md:w-96 lg:mb-0">
                            <img src="https://tecdn.b-cdn.net/img/Photos/Avatars/img%20%2810%29.jpg" class="rounded-full shadow-md dark:shadow-black/30" alt="woman avatar" />
                        </div>
                        <div class="md:ms-6">
                            <p class="mb-6 font-light text-neutral-500 dark:text-neutral-300">
                                "Nous avons gagné en efficacité et en qualité de soins depuis que nous utilisons Soft Care. Un outil indispensable."
                            </p>
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                    <div class="md:flex md:flex-row m-4 p-6 absolute block bg-white rounded-md -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 ">
                        ...
                        <div class="md:ms-6">
                            <p class="mb-6 font-light text-neutral-500 dark:text-neutral-300">
                                "Soft Care a transformé notre clinique. La gestion est plus fluide et nos patients sont plus satisfaits."
                            </p>
                            <p class="mb-2 text-xl font-semibold text-neutral-800 dark:text-neutral-200">
                                Dr. Anne Leroy
                            </p>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Vous serez en bonne compagnie</h2>
...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Entreprise</h2>
