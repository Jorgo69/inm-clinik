<x-try-layout>    
    ...
    {{-- Hero Section --}}
    <header class="bg-center  bg-no-repeat h-full w-full bg-scroll hover:bg-fixed object-cover bg-gray-400 bg-blend-multiply" style="background-image: url('/assets/header-doctor-femme.jpg');">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                ...
                <a href="{{route('try.about')}}" class="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
    ...
    <section class=" mx-4 my-8 bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            ...
            <x-grid-tree-reponsive >
                <div class="p-4 bg-gray-50 rounded-md hover:bg-gray-100 hover:p-4.5">
