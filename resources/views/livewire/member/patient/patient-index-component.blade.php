                        ...
                        <tbody id="resultats" class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        ...
                                        <div class="flex items-center gap-x-6">
                                            ...
                                            <div x-data="{ isOpen: false }" class="relative inline-block ">
                                                ...
                                                class="absolute bottom-0 right-0 z-100 w-48 py-2 mt-2 origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800">
                                                    ...
                                                    <a x-data x-on:click="$dispatch('open-modal', {patientId: '{{$patient->id}}'})" type="button" href="#" class="appointment-link block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                                                        <x-svg-appointment/>
                                                        RDV
                                                    </a>
                                                </div>
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <!-- Modal body -->
                                    <form class="p-4 md:p-5" action="'{{ route('member.secretary.store.appointment', ['clinic_id' => $clinicId, 'patient_id' => $patient->id]) }}'">
                                        @csrf
