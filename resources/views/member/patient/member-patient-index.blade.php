                            ...
                            <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                ...
                                <template id="result-template">
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white"><!-- Nom du patient --></h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400"><!-- Email du patient --></p>
                                            </div>
                                        </td>
                                
                                        <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                            <div class="inline sexe px-3 py-1 text-sm font-normal rounded-full text-emerald-500 gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                                <span class="sexe">
                                                    {{-- Patient Sexe --}}
                                                </span>
                                            </div>
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div class="flex items-center gap-x-6">
                                                <x-dropdown-button/>
                                                {{-- <a href="#" class="font-medium mx-4 text-gray-500 dark:text-blue-500 hover:underline details-link">
                                                    <x-svg-detail/>
                                                    Details
                                                </a> --}}
                                            </div>
