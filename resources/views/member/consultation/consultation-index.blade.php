                      ...
                      <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                              ...
                              <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    ...
                                    <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                      ...
                                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                                              <div class="flex items-center gap-x-6">
                                                  ...
                                                  {{-- <x-nav-link href="{{route('member.consultation.detail.show', ['clinic_id' => $clinic->id, 'patient_id'])}}" class="text-gray-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-gray-300 hover:text-primaryHover focus:outline-none">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                  ...
                                  <tr><td colspan="6" class="px-4 py-4 text-sm text-center">Aucune consultation effectuer</td></tr>
