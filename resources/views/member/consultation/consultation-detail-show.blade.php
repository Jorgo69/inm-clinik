        ...
        <div class="container px-6 py-10 mx-auto">
            ...
            <section class="mt-8 space-y-8 lg:mt-12">
                <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                    ...
                    <form action="{{route('member.consultation.create', ['clinic_id' => $clinic->id, 'patient_id' => $patient->id, 'concerned_id' => auth()->user()->id])}}" method="POST">
                        @csrf
                        @method('POST')
                        ...
                        <div class="flex justify-end mt-6">
                            <x-primary-button>Noter</x-primary-button>
