                                ...
                                <form action="{{route('try.ask.post')}}" method="POST">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 place-content-stretch">
                                            <x-text-input placeholder="Nom Complet *" name="full_name"/>
                                            <x-text-input placeholder="Titre d'emploi" name="job_title" />
                                            <x-text-input placeholder="Nom de l'hopital *" name="hospital_name" />
                                            <x-text-input placeholder="Email de travail*" name="work_email" />
                                            <x-text-input placeholder="Numero Whatsapp *" name="whatsapp_number" />
              ...
              <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li class="mb-4">
                            <a href="{{route('try.contact')}}" class="hover:underline">Contact Us</a>
                        </li>
                    </ul>
                </div>
                <div>
